...
import type { LoginData, LoginResponses, LogoutData, LogoutResponses, CreateLeagueData, CreateLeagueResponses, CreateConfigData, CreateConfigResponses, UpdateConfigData, UpdateConfigResponses, RenameConfigData, RenameConfigResponses, DeleteConfigData, DeleteConfigResponses, DuplicateConfigData, DuplicateConfigResponses, AssignConfigData, AssignConfigResponses } from './types.gen';
 ...
 */
export const assignConfig = <ThrowOnError extends boolean = false>(options: Options<AssignConfigData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<AssignConfigResponses, unknown, ThrowOnError>({
        security: [
            {
                in: 'cookie',
                name: 'SCS_SESSION_ID',
