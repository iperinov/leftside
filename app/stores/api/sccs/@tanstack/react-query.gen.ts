...
import { type Options, login, logout, createLeague, createConfig, updateConfig, renameConfig, deleteConfig, duplicateConfig, assignConfig } from '../sdk.gen';
import { queryOptions, type UseMutationOptions, type DefaultError } from '@tanstack/react-query';
import type { LoginData, LoginResponse, LogoutData, LogoutResponse, CreateLeagueData, CreateLeagueResponse2, CreateConfigData, CreateConfigResponse2, UpdateConfigData, UpdateConfigResponse2, RenameConfigData, RenameConfigResponse2, DeleteConfigData, DeleteConfigResponse2, DuplicateConfigData, DuplicateConfigResponse2, AssignConfigData, AssignConfigResponse } from '../types.gen';
 ...
 * This method is used to create a league
 */
export const createLeagueMutation = (options?: Partial<Options<CreateLeagueData>>): UseMutationOptions<CreateLeagueResponse2, DefaultError, Options<CreateLeagueData>> => {
 ...
 * Creates a new configuration
 */
export const createConfigMutation = (options?: Partial<Options<CreateConfigData>>): UseMutationOptions<CreateConfigResponse2, DefaultError, Options<CreateConfigData>> => {
 ...
 * Updates a configuration
 */
export const updateConfigMutation = (options?: Partial<Options<UpdateConfigData>>): UseMutationOptions<UpdateConfigResponse2, DefaultError, Options<UpdateConfigData>> => {
 ...
 * Rename, changes the configuration's name.
 */
export const renameConfigMutation = (options?: Partial<Options<RenameConfigData>>): UseMutationOptions<RenameConfigResponse2, DefaultError, Options<RenameConfigData>> => {
 ...
 * Deletes a configuration permanently.
 */
export const deleteConfigMutation = (options?: Partial<Options<DeleteConfigData>>): UseMutationOptions<DeleteConfigResponse2, DefaultError, Options<DeleteConfigData>> => {
 ...
 *
 */
export const duplicateConfigMutation = (options?: Partial<Options<DuplicateConfigData>>): UseMutationOptions<DuplicateConfigResponse2, DefaultError, Options<DuplicateConfigData>> => {
...
export const assignConfigQueryKey = (options: Options<AssignConfigData>) => createQueryKey('assignConfig', options);

/**
 * Assigns a config to books
 */
export const assignConfigOptions = (options: Options<AssignConfigData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await assignConfig({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: assignConfigQueryKey(options)
    });
};
 ...
 * Assigns a config to books
 */
export const assignConfigMutation = (options?: Partial<Options<AssignConfigData>>): UseMutationOptions<AssignConfigResponse, DefaultError, Options<AssignConfigData>> => {
    const mutationOptions: UseMutationOptions<AssignConfigResponse, DefaultError, Options<AssignConfigData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await assignConfig({
                ...options,
                ...localOptions,
