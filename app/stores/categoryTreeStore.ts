...
export const useCategoryTreeStore = create<CategoryTreeState & CategoryTreeGetters & CategoryTreeMutations & ConfigurationMutations & AssignedBookMutations>(
  (set, get) => ({
    // State
    ...
    // Mutations
    reset: (configuration, categoriesTree, assignedBooks) => {
      set((state) => ({
