...
((global, factory) => {
  ...
  function report(_ref) {
    const { nodesTested, nodesFound } = _ref;
    const timedOutTests = {};
  ...
  function pollUntil(_ref) {
    const { fn = () => true, initialDuration = 1, maxDuration = WINDOW.FontAwesomeDetection.timeout, showProgress = false, progressIndicator } = _ref;
  ...
  function setDoneResults(_ref2) {
    const { nodesTested, nodesFound } = _ref2;
