...
export const mockLeagues: Configuration[] = [
  {
    ...
    name: "Default",
    books: [
      1, 2, 3, 5, 10, 11, 13, 16, 22, 23, 26, 27, 28, 29, 30, 31, 33, 34, 35,
      39, 40, 41, 42,
    ],
  ...
  },
  {
    ...
    books: [
      104, 106, 107, 108, 109, 110, 111, 112, 113, 114, 115, 119, 120, 121, 122,
      123, 124,
    ],
  ...
  },
  {
    ...
    books: [
      126, 127, 128, 129, 130, 131, 132, 133, 134, 137, 140, 141, 142, 143, 144,
      145, 146, 147, 148,
    ],
