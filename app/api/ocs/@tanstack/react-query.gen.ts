...
import {
  type Options,
  getConfigBanners,
  getConfigBannersTranslations,
  getConfigBooks,
  getConfigCashoutsRulesPerEvent,
  getConfigCashoutsRulesPerLeague,
  getConfigEvents,
  getConfigEventsTranslations,
  getConfigGameTypes,
  getConfigLeagueByEventById,
  getConfigLeagueById,
  getConfigLeagues,
  getConfigLeaguesByEvents,
  getConfigLeaguesTranslations,
  getConfigPeriods,
  getConfigPlayerByAccountByNumber,
  getConfigPlayerById,
  getConfigRealsports,
  getConfigRealsportsTranslations,
  getConfigRegions,
  getConfigTakeBackProfileById,
  getConfigTakeBackProfiles,
  getConfigTakeBackSettings,
  getConfigTeams,
  getConfigTeamsSearchByPattern,
  postConfigTeams,
  postSportEntities,
} from "../sdk.gen";
import type {
  GetConfigBannersData,
  GetConfigBannersTranslationsData,
  GetConfigBooksData,
  GetConfigCashoutsRulesPerEventData,
  GetConfigCashoutsRulesPerLeagueData,
  GetConfigEventsData,
  GetConfigEventsTranslationsData,
  GetConfigGameTypesData,
  GetConfigLeagueByEventByIdData,
  GetConfigLeagueByIdData,
  GetConfigLeaguesByEventsData,
  GetConfigLeaguesData,
  GetConfigLeaguesTranslationsData,
  GetConfigPeriodsData,
  GetConfigPlayerByAccountByNumberData,
  GetConfigPlayerByIdData,
  GetConfigRealsportsData,
  GetConfigRealsportsTranslationsData,
  GetConfigRegionsData,
  GetConfigTakeBackProfileByIdData,
  GetConfigTakeBackProfilesData,
  GetConfigTakeBackSettingsData,
  GetConfigTeamsData,
  GetConfigTeamsSearchByPatternData,
  PostConfigTeamsData,
  PostConfigTeamsError,
  PostConfigTeamsResponse,
  PostSportEntitiesData,
  PostSportEntitiesError,
  PostSportEntitiesResponse,
} from "../types.gen";
...
export const getConfigLeaguesTranslationsQueryKey = (options?: Options<GetConfigLeaguesTranslationsData>) =>
  createQueryKey("getConfigLeaguesTranslations", options);
...
export const getConfigTakeBackProfileByIdQueryKey = (options: Options<GetConfigTakeBackProfileByIdData>) =>
  createQueryKey("getConfigTakeBackProfileById", options);
...
export const getConfigEventsTranslationsQueryKey = (options?: Options<GetConfigEventsTranslationsData>) =>
  createQueryKey("getConfigEventsTranslations", options);
...
export const getConfigRealsportsTranslationsQueryKey = (options?: Options<GetConfigRealsportsTranslationsData>) =>
  createQueryKey("getConfigRealsportsTranslations", options);
...
export const getConfigPlayerByAccountByNumberQueryKey = (options: Options<GetConfigPlayerByAccountByNumberData>) =>
  createQueryKey("getConfigPlayerByAccountByNumber", options);
 ...
 * The method will accept a JSON will an array of teams.
 */
export const postConfigTeamsMutation = (
  options?: Partial<Options<PostConfigTeamsData>>,
): UseMutationOptions<PostConfigTeamsResponse, PostConfigTeamsError, Options<PostConfigTeamsData>> => {
...
export const getConfigTeamsSearchByPatternQueryKey = (options: Options<GetConfigTeamsSearchByPatternData>) =>
  createQueryKey("getConfigTeamsSearchByPattern", options);
...
export const getConfigCashoutsRulesPerLeagueQueryKey = (options?: Options<GetConfigCashoutsRulesPerLeagueData>) =>
  createQueryKey("getConfigCashoutsRulesPerLeague", options);
...
export const getConfigCashoutsRulesPerEventQueryKey = (options?: Options<GetConfigCashoutsRulesPerEventData>) =>
  createQueryKey("getConfigCashoutsRulesPerEvent", options);
...
export const getConfigBannersTranslationsQueryKey = (options?: Options<GetConfigBannersTranslationsData>) =>
  createQueryKey("getConfigBannersTranslations", options);
 ...
 * Create real-sport, region, and league entities
 */
export const postSportEntitiesMutation = (
  options?: Partial<Options<PostSportEntitiesData>>,
): UseMutationOptions<PostSportEntitiesResponse, PostSportEntitiesError, Options<PostSportEntitiesData>> => {
