...
import type {
  ...
  GetConfigBannersErrors,
  GetConfigBannersResponses,
  GetConfigBannersTranslationsData,
  GetConfigBannersTranslationsErrors,
  GetConfigBannersTranslationsResponses,
  GetConfigBooksData,
  GetConfigBooksErrors,
  GetConfigBooksResponses,
  GetConfigCashoutsRulesPerEventData,
  GetConfigCashoutsRulesPerEventErrors,
  GetConfigCashoutsRulesPerEventResponses,
  GetConfigCashoutsRulesPerLeagueData,
  GetConfigCashoutsRulesPerLeagueErrors,
  GetConfigCashoutsRulesPerLeagueResponses,
  GetConfigEventsData,
  GetConfigEventsErrors,
  GetConfigEventsResponses,
  GetConfigEventsTranslationsData,
  GetConfigEventsTranslationsErrors,
  GetConfigEventsTranslationsResponses,
  GetConfigGameTypesData,
  GetConfigGameTypesErrors,
  GetConfigGameTypesResponses,
  GetConfigLeagueByEventByIdData,
  GetConfigLeagueByEventByIdErrors,
  GetConfigLeagueByEventByIdResponses,
  GetConfigLeagueByIdData,
  GetConfigLeagueByIdErrors,
  GetConfigLeagueByIdResponses,
  GetConfigLeaguesByEventsData,
  GetConfigLeaguesByEventsErrors,
  GetConfigLeaguesByEventsResponses,
  GetConfigLeaguesData,
  GetConfigLeaguesErrors,
  GetConfigLeaguesResponses,
  GetConfigLeaguesTranslationsData,
  GetConfigLeaguesTranslationsErrors,
  GetConfigLeaguesTranslationsResponses,
  GetConfigPeriodsData,
  GetConfigPeriodsErrors,
  GetConfigPeriodsResponses,
  GetConfigPlayerByAccountByNumberData,
  GetConfigPlayerByAccountByNumberErrors,
  GetConfigPlayerByAccountByNumberResponses,
  GetConfigPlayerByIdData,
  GetConfigPlayerByIdErrors,
  GetConfigPlayerByIdResponses,
  GetConfigRealsportsData,
  GetConfigRealsportsErrors,
  GetConfigRealsportsResponses,
  GetConfigRealsportsTranslationsData,
  GetConfigRealsportsTranslationsErrors,
  GetConfigRealsportsTranslationsResponses,
  GetConfigRegionsData,
  GetConfigRegionsErrors,
  GetConfigRegionsResponses,
  GetConfigTakeBackProfileByIdData,
  GetConfigTakeBackProfileByIdErrors,
  GetConfigTakeBackProfileByIdResponses,
  GetConfigTakeBackProfilesData,
  GetConfigTakeBackProfilesErrors,
  GetConfigTakeBackProfilesResponses,
  GetConfigTakeBackSettingsData,
  GetConfigTakeBackSettingsErrors,
  GetConfigTakeBackSettingsResponses,
  GetConfigTeamsData,
  GetConfigTeamsErrors,
  GetConfigTeamsResponses,
  GetConfigTeamsSearchByPatternData,
  GetConfigTeamsSearchByPatternErrors,
  GetConfigTeamsSearchByPatternResponses,
  PostConfigTeamsData,
  PostConfigTeamsErrors,
  PostConfigTeamsResponses,
  PostSportEntitiesData,
  PostSportEntitiesErrors,
  PostSportEntitiesResponses,
} from "./types.gen";
 ...
 * This method is used to get an information about a player registered in the system
 */
export const getConfigPlayerByAccountByNumber = <ThrowOnError extends boolean = false>(
  options: Options<GetConfigPlayerByAccountByNumberData, ThrowOnError>,
) => {
