...
import { type Options, login, logout, createLeague, createConfig, updateConfig, renameConfig, deleteConfig, duplicateConfig, assignBooks } from '../sdk.gen';
import { queryOptions, type UseMutationOptions, type DefaultError } from '@tanstack/react-query';
import type { LoginData, LoginResponse, LogoutData, LogoutResponse, CreateLeagueData, CreateLeagueResponse2, CreateConfigData, CreateConfigResponse2, UpdateConfigData, UpdateConfigResponse2, RenameConfigData, RenameConfigResponse2, DeleteConfigData, DeleteConfigResponse2, DuplicateConfigData, DuplicateConfigResponse2, AssignBooksData, AssignBooksResponse2 } from '../types.gen';
 ...
 * Assigns a config to books
 */
export const assignBooksMutation = (options?: Partial<Options<AssignBooksData>>): UseMutationOptions<AssignBooksResponse2, DefaultError, Options<AssignBooksData>> => {
